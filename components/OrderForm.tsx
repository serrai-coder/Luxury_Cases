...
const OrderForm: React.FC<OrderFormProps> = ({ onOrderSuccess }) => {
  ...
  const validateForm = (): boolean => {
    ...
    if (!phone.trim()) {
      ...
      newErrors.phone =
        'الرجاء إدخال رقم هاتف صحيح (10 أرقام يبدأ بـ 05, 06 أو 07).';
    }
  ...
  const totalPrice =
    typeof deliveryPrice === 'number' ? productPrice + deliveryPrice : productPrice;
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const selectedBaladiya = selectedWilaya?.cities.find(
      (c) => c.id === parseInt(selectedBaladiyaId, 10)
    );
    ...
    try {
      ...
      const notionPageData = {
        ...
        properties: {
          ...
          Produit: { rich_text: [{ text: { content: orderDetails.phoneModel } }] },
      ...
      <div className="container mx-auto px-6">
        <div className="max-w-2xl mx-auto bg-white p-8 rounded-2xl shadow-2xl">
          ...
          <p className="text-center text-gray-600 mb-8">
            املأ المعلومات التالية لتأكيد طلبك. سنتصل بك قريبًا.
          </p>
          <form onSubmit={handleSubmit} noValidate>
            <div className="space-y-6">
              ...
              <div>
                ...
                {errors.phoneModel && (
                  <p className="text-red-500 mt-1">{errors.phoneModel}</p>
                )}
              </div>
              ...
              <div>
                ...
                {errors.baladiya && (
                  <p className="text-red-500 mt-1">{errors.baladiya}</p>
                )}
              </div>
                  ...
                  <label className="flex items-center p-4 border rounded-lg cursor-pointer hover:bg-gray-100">
                    ...
                    <span className="mr-3 text-gray-800">
                      ...
                      <span className="font-bold">
                        {getDeliveryPrice(DeliveryType.Home)} دج
                      </span>
                    </span>
                  </label>
                  <label className="flex items-center p-4 border rounded-lg cursor-pointer hover:bg-gray-100">
                    ...
                    <span className="mr-3 text-gray-800">
                      توصيل للمكتب -{' '}
                      <span className="font-bold">
                        {getDeliveryPrice(DeliveryType.StopDesk)} دج
                      </span>
                    </span>
                  </label>
                </div>
                {errors.deliveryType && (
                  <p className="text-red-500 mt-1">{errors.deliveryType}</p>
                )}
              </div>
